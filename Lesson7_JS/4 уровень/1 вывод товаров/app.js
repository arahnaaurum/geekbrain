...
let productPoint = document.querySelector('.products');
...
function showCategory(category) {
    for (let i = 0; i < products[category].length; i++) {
        ...
        let textHTML = getProductMarkup(product);
        productPoint.insertAdjacentHTML('afterBegin', textHTML);
    }
}
